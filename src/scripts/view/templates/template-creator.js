...
<div id="contentdetail" class="resto__detail">
  <div class="resto__info__detail">
    ...
    <img loading="lazy" class="image_detail lazyload" crossorigin="anonymous" data-srcset="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}" alt="${restaurant.name}" title="${restaurant.name}" />
...
const createRestoItemTemplate = (restaurant) => `
  <div class="card" tabindex="0">
    ...
    <div class="content">
      ...
      <h2 tabindex="0" class="content__restaurant-title">${restaurant.name}</h2>
