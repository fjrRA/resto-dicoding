...
// Do precaching
precacheAndRoute([{'revision':'dc32bf8876a3e7bfa132ad32a7a5b91c','url':'97.bundle.js'},{'revision':null,'url':'a174fcfb1a82c6b25273.jpg'},{'revision':'f9304d84b8c059dd064772bc02281ccb','url':'app.webmanifest'},{'revision':'5bb095434c31fe955e52e6cf0855540a','url':'app~7bd12dde.bundle.js'},{'revision':'60556f5353484ffef921a3e70e8b3143','url':'app~d0362038.bundle.js'},{'revision':'81206abd7a5713774f7efd75dc176da1','url':'app~d1658f4b.bundle.js'},{'revision':'ace6abe7642f69d8dc92fc702201efda','url':'app~e4317507.bundle.js'},{'revision':'0760fae8cf2d2b172678847987d1d95c','url':'data/DATA.json'},{'revision':null,'url':'e21bf0619419a1f63192.jpg'},{'revision':'3d7d7aa15b44ef9c864b1b3d9c1c3c67','url':'favicon.png'},{'revision':'34d9d8d646af9f294d968811da10e546','url':'icons/icon-128x128.png'},{'revision':'2dd174daa627ee198c37c9dfe8cdc34d','url':'icons/icon-144x144.png'},{'revision':'42ee3d984a8d535d697ccbb4428e8647','url':'icons/icon-152x152.png'},{'revision':'923e1610b9d68d2445eb28d6e0f54aaa','url':'icons/icon-192x192.png'},{'revision':'7f775b04df567c8d90c9bad2c89e2d81','url':'icons/icon-384x384.png'},{'revision':'f6705cd9d5d52d8483a2bf9b47cb5f60','url':'icons/icon-512x512.png'},{'revision':'1d463ddf39f394788393e31e1f0e9dbc','url':'icons/icon-72x72.png'},{'revision':'7619371082a792ebb06768c13bf094bf','url':'icons/icon-96x96.png'},{'revision':'ff14407015b5a9959796f4285074c14f','url':'index.html'}]);
var restoDicodingApi = new Route(function (_ref) {
  var url = _ref.url;
  return url.href.startsWith('https://restaurant-api.dicoding.dev');
}, new StaleWhileRevalidate({
  cacheName: new Date().toISOString()
}));
var restoDicodingImageApi = new Route(function (_ref2) {
  var url = _ref2.url;
...
self.addEventListener('push', function (event) {
  ...
  var showNotification = self.registration.showNotification(notificationData.title, notificationData.options);
